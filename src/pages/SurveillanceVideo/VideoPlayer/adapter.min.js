  ...
  })(
    {
      ...
      2: [
        function (e, t, r) {
                ...
                for (var e = 0; e < p.codecs.length; e++) {
                  ...
                  if (
                    ...
                    if (
                      ...
                      (o = p.codecs),
                      (c = s = void 0),
                      (s = f(n.parameters.apt, a)),
                      (c = f(i.parameters.apt, o)),
          ...
          t.exports = function (D, L) {
            function j(e, t) {
              t.addTrack(e),
                t.dispatchEvent(
                  new D.MediaStreamTrackEvent('addtrack', { track: e }),
                );
            }
            function i(e, t, r, n) {
            ...
            (n.prototype.onicecandidate = null),
              ...
              (n.prototype.addTrack = function (t, e) {
                ...
                return (
                  ...
                  (r.track = t),
                  (r.stream = e),
                  (r.rtpSender = new D.RTCRtpSender(t, r.dtlsTransport)),
                  r.rtpSender
                );
              }),
              ...
              (n.prototype.removeTrack = function (t) {
                ...
                if (!(t instanceof D.RTCRtpSender))
                  throw new TypeError(
                      ...
                      if (!(d.usingBundle && 0 < c)) {
                        ...
                        (a[t.candidate.sdpMLineIndex] += n
                          ...
                          (d.localDescription.sdp =
                            N.getDescription(d.localDescription.sdp) +
                            a.join(''));
              ...
              (n.prototype.setLocalDescription = function (e) {
                ...
                if (-1 === ['offer', 'answer'].indexOf(e.type))
                  return Promise.reject(
                    h('TypeError', 'Unsupported type "' + e.type + '"'),
                  );
                if (
                ...
                if ('offer' === e.type)
                  ...
                  (t = N.splitSections(f.remoteDescription.sdp)),
                    (u = t.shift());
                ...
                return (
                  (f.localDescription = { type: e.type, sdp: e.sdp }),
                  'offer' === e.type
              ...
              (n.prototype.setRemoteDescription = function (w) {
                ...
                if (-1 === ['offer', 'answer'].indexOf(w.type))
                  return Promise.reject(
                    h('TypeError', 'Unsupported type "' + w.type + '"'),
                  );
                if (
                  !a('setRemoteDescription', w.type, k.signalingState) ||
                  k._isClosed
                )
                  return Promise.reject(
                    h(
                ...
                var x = {};
                k.remoteStreams.forEach(function (e) {
                  x[e.id] = e;
                });
                var _ = [],
                  e = N.splitSections(w.sdp),
                  O = e.shift(),
                  M = 0 < N.matchPrefix(O, 'a=ice-lite').length,
                  I = 0 < N.matchPrefix(O, 'a=group:BUNDLE ').length;
                k.usingBundle = I;
                var t = N.matchPrefix(O, 'a=ice-options:')[0];
                return (
                  (k.canTrickleIceCandidates =
                  ...
                  e.forEach(function (e, t) {
                    ...
                    if (('application' === n && 'DTLS/SCTP' === a) || i)
                      k.transceivers[t] = { mid: c, kind: n, rejected: !0 };
                    else {
                      var d, p, u, f, l, m, h, v, g;
                      !i &&
                        k.transceivers[t] &&
                        k.transceivers[t].rejected &&
                        (k.transceivers[t] = k._createTransceiver(n, !0));
                      var y,
                        C,
                        T = N.parseRtpParameters(e);
                      i ||
                        ((y = N.getIceParameters(e, O)),
                        ((C = N.getDtlsParameters(e, O)).role = 'client')),
                        (h = N.parseRtpEncodingParameters(e));
                      var S = N.parseRtcpParameters(e),
                        P =
                          0 < N.matchPrefix(e, 'a=end-of-candidates', O).length,
                        R = N.matchPrefix(e, 'a=candidate:')
                          .map(function (e) {
                      ...
                      if (
                        (('offer' === w.type || 'answer' === w.type) &&
                          !i &&
                          I &&
                          0 < t &&
                          k.transceivers[t] &&
                          (k._disposeIceAndDtlsTransports(t),
                          (k.transceivers[t].iceGatherer =
                            k.transceivers[0].iceGatherer),
                          (k.transceivers[t].iceTransport =
                            k.transceivers[0].iceTransport),
                          (k.transceivers[t].dtlsTransport =
                            k.transceivers[0].dtlsTransport),
                          k.transceivers[t].rtpSender &&
                            k.transceivers[t].rtpSender.setTransport(
                              k.transceivers[0].dtlsTransport,
                            ),
                          k.transceivers[t].rtpReceiver &&
                            k.transceivers[t].rtpReceiver.setTransport(
                              k.transceivers[0].dtlsTransport,
                            )),
                        'offer' !== w.type || i)
                      )
                        'answer' !== w.type ||
                          i ||
                          ((p = (d = k.transceivers[t]).iceGatherer),
                          (u = d.iceTransport),
                          (f = d.dtlsTransport),
                          (l = d.rtpReceiver),
                          (m = d.sendEncodingParameters),
                          (v = d.localCapabilities),
                          (k.transceivers[t].recvEncodingParameters = h),
                          (k.transceivers[t].remoteCapabilities = T),
                          (k.transceivers[t].rtcpParameters = S),
                          R.length &&
                            'new' === u.state &&
                            ((!M && !P) || (I && 0 !== t)
                          ...
                          (I && 0 !== t) ||
                            ('new' === u.state && u.start(p, y, 'controlling'),
                          ...
                          !l || ('sendrecv' !== o && 'sendonly' !== o)
                            ...
                            : ((g = l.track),
                              s
                                ? (x[s.stream] ||
                                    (x[s.stream] = new D.MediaStream()),
                                  j(g, x[s.stream]),
                                  _.push([g, l, x[s.stream]]))
                                : (x.default ||
                                    (x.default = new D.MediaStream()),
                                  j(g, x.default),
                                  _.push([g, l, x.default]))));
                      else {
                        ((d =
                          k.transceivers[t] || k._createTransceiver(n)).mid =
                          c),
                          d.iceGatherer ||
                            (d.iceGatherer = k._createIceGatherer(t, I)),
                          R.length &&
                          ...
                          (v = D.RTCRtpReceiver.getCapabilities(n)),
                          L < 15019 &&
                        ...
                        if ('sendrecv' === o || 'sendonly' === o) {
                          if (
                            ...
                            (l =
                              d.rtpReceiver ||
                              new D.RTCRtpReceiver(d.dtlsTransport, n)),
                            E)
                          )
                            (g = l.track),
                              (s && '-' === s.stream) ||
                                (s
                                  ? (x[s.stream] ||
                                      ((x[s.stream] = new D.MediaStream()),
                                      Object.defineProperty(x[s.stream], 'id', {
                                        get: function () {
                                          return s.stream;
                                        },
                                      })),
                          ...
                          d.rtpReceiver &&
                            ...
                            (d.associatedRemoteMediaStreams.forEach(function (
                              ...
                              n &&
                                ...
                                (r = e).removeTrack(t),
                                r.dispatchEvent(
                                  new D.MediaStreamTrackEvent('removetrack', {
                                    track: t,
                                  }),
                                ));
                            }),
                        ...
                        (d.localCapabilities = v),
                          ...
                          k._transceive(k.transceivers[t], !1, E);
                      }
                    }
                  }),
                  void 0 === k._dtlsRole &&
                    (k._dtlsRole = 'offer' === w.type ? 'active' : 'passive'),
                  (k.remoteDescription = { type: w.type, sdp: w.sdp }),
                  'offer' === w.type
                    ? k._updateSignalingState('have-remote-offer')
                    : k._updateSignalingState('stable'),
                  Object.keys(x).forEach(function (e) {
                    var n = x[e];
                    if (n.getTracks().length) {
                      if (-1 === k.remoteStreams.indexOf(n)) {
                        k.remoteStreams.push(n);
                        var t = new Event('addstream');
                        (t.stream = n),
                          D.setTimeout(function () {
                            k._dispatchEvent('addstream', t);
                          });
                      }
                      _.forEach(function (e) {
                        var t = e[0],
                          r = e[1];
                        n.id === e[2].id && i(k, t, r, [n]);
                      });
                    }
                  }),
                  _.forEach(function (e) {
                  ...
                  D.setTimeout(function () {
                    k &&
                      k.transceivers &&
                      k.transceivers.forEach(function (e) {
                        e.iceTransport &&
              ...
              (n.prototype.createOffer = function () {
                ...
                var n = N.writeSessionBoilerplate(
                  s._sdpSessionId,
                ...
                s.transceivers.forEach(function (e, t) {
                  ...
                  r &&
                    ...
                    e.wantReceive &&
                      (e.rtpReceiver = new D.RTCRtpReceiver(
                        e.dtlsTransport,
                        n,
                      )),
                    ...
                    (n += c(
                      ...
                      !e.iceGatherer ||
                        ...
                        (e.iceGatherer
                          ...
                          .forEach(function (e) {
                            (e.component = 1),
                              (n += 'a=' + N.writeCandidate(e) + '\r\n');
                          }),
                        'completed' === e.iceGatherer.state &&
                          (n += 'a=end-of-candidates\r\n'));
                  });
                var i = new D.RTCSessionDescription({ type: 'offer', sdp: n });
              ...
              (n.prototype.createAnswer = function () {
                ...
                var e = new D.RTCSessionDescription({ type: 'answer', sdp: a });
                ...
                return c && void 0 === c.sdpMLineIndex && !c.sdpMid
                  ...
                  : new Promise(function (e, t) {
                      ...
                      if (c && '' !== c.candidate) {
                        ...
                        if (!i)
                          return t(
                            h('OperationError', 'Can not add ICE candidate'),
                          );
                        if (i.rejected) return e();
                        var a =
                          0 < Object.keys(c.candidate).length
                            ? N.parseCandidate(c.candidate)
                            : {};
                        if (
                          'tcp' === a.protocol &&
                          (0 === a.port || 9 === a.port)
                        ...
                        0 === o.indexOf('a=') && (o = o.substr(2)),
                          ((d = N.getMediaSections(p.remoteDescription.sdp))[
                            r
                          ] +=
                            'a=' + (a.type ? o : 'end-of-candidates') + '\r\n'),
                          (p.remoteDescription.sdp = d.join(''));
                      } else for (var s = 0; s < p.transceivers.length && (p.transceivers[s].rejected || (p.transceivers[s].iceTransport.addRemoteCandidate({}), ((d = N.getMediaSections(p.remoteDescription.sdp))[s] += 'a=end-of-candidates\r\n'), (p.remoteDescription.sdp = N.getDescription(p.remoteDescription.sdp) + d.join('')), !p.usingBundle)); s++);
                      e();
                    });
              }),
      ...
      5: [
        function (l, e, t) {
          ...
          e.exports = function (e, t) {
            ...
            switch (o.browser) {
              case 'chrome':
                if (!s || !s.shimPeerConnection || !n.shimChrome)
                  return (
                    a('Chrome shim is not included in this adapter release.'), f
                  );
                ...
                break;
              case 'firefox':
                if (!d || !d.shimPeerConnection || !n.shimFirefox)
                  return (
                    a('Firefox shim is not included in this adapter release.'),
                    f
                  );
                ...
                break;
              case 'edge':
                if (!c || !c.shimPeerConnection || !n.shimEdge)
                  return (
                    a('MS edge shim is not included in this adapter release.'),
                    f
                  );
                a('adapter.js shimming edge.'),
                  ...
                  c.shimPeerConnection(r),
                  c.shimReplaceTrack(r),
                  u.shimMaxMessageSize(r),
                  u.shimSendThrowTypeError(r);
                break;
              case 'safari':
                if (!p || !n.shimSafari)
                  return (
                    a('Safari shim is not included in this adapter release.'), f
                  );
        ...
        function (e, t, r) {
          ...
          t.exports = {
                          ...
                          e
                            ? ((this.src = r.createObjectURL(e)),
                              e.addEventListener('addtrack', function () {
                                t.src && r.revokeObjectURL(t.src),
                                  (t.src = r.createObjectURL(e));
                              }),
                ...
                return (
                  arguments.length &&
                    ...
                    (arguments[0] =
                      ...
                      (e = arguments[0]),
                      (i = e.sdp),
                      Object.keys(n._reverseStreams || []).forEach(function (
                        e,
                      ) {
                        var t = n._reverseStreams[e],
                          r = n._streams[t.id];
                  ...
                  (n._streams = n._streams || {}),
                    ...
                    r &&
                      (1 === r.getTracks().length
                        ? n.removeStream(n._reverseStreams[r.id])
            ...
            shimPeerConnection: function (r) {
              ...
              if (!r.RTCPeerConnection && r.webkitRTCPeerConnection)
                (r.RTCPeerConnection = function (e, t) {
                  return (
                    ...
                    new r.webkitRTCPeerConnection(e, t)
                  );
                }),
                  (r.RTCPeerConnection.prototype =
                    r.webkitRTCPeerConnection.prototype),
                ...
                (r.RTCPeerConnection = function (e, t) {
                  ...
                  (r.RTCPeerConnection.prototype = a.prototype),
                  Object.defineProperty(
                    r.RTCPeerConnection,
                    'generateCertificate',
                    {
                          ...
                          (this._ontrackpoly = function (r) {
                            r.stream.getTracks().forEach(
                              function (e) {
                                ...
                                (t.track = e),
                                  (t.receiver = { track: e }),
                                  (t.transceiver = { receiver: t.receiver }),
                                  (t.streams = [r.stream]),
                                  this.dispatchEvent(t);
                              }.bind(this),
                            );
              ...
              if (
                ...
                s.RTCPeerConnection ||
                  ...
                  (s.RTCPeerConnection.prototype =
                    s.mozRTCPeerConnection.prototype),
                  ...
                  return (
                    Object.keys(n).forEach(function (e) {
                      if (
                        ...
                        var t = (n[e] =
                          'object' == typeof n[e] ? n[e] : { ideal: n[e] });
                        if (
                          ((void 0 === t.min &&
                            void 0 === t.max &&
                            void 0 === t.exact) ||
              ...
              if ('object' == typeof e && e.RTCPeerConnection) {
                if (
                  ...
                  (e.RTCPeerConnection.prototype.addStream = function (t) {
                    this._localStreams || (this._localStreams = []),
                      -1 === this._localStreams.indexOf(t) &&
