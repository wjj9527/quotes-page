var WebRtcStreamer = (function () {
  ...
  var WebRtcStreamer = function WebRtcStreamer(videoElement, srvurl) {
    ...
    this.srvurl =
      srvurl ||
      location.protocol + '//' + window.location.hostname + ':' + '20105';
    this.pc = null;
    ...
    pc.oniceconnectionstatechange = function (evt) {
      ...
      if (bind.videoElement) {
        if (pc.iceConnectionState === 'connected') {
          ...
          if (document.getElementById('WebRtcStreamerTip')) {
            document.getElementById('WebRtcStreamerTip').style.display = 'none';
          } else {
            tip();
          }
          ...
          if (document.getElementById('WebRtcStreamerTip')) {
            document.getElementById('WebRtcStreamerTip').style.display =
              'block';
          } else {
            tip();
          }
...
const tip = () => {
  ...
  tipBox.setAttribute('id', 'WebRtcStreamerTip');
  tipBox.style.display = 'none';
  tipBox.style.position = 'fixed';
  tipBox.style.top = '200px';
  tipBox.style.right = '45%';
  tipBox.style.padding = '3px 50px';
  tipBox.style.background = '#fff';
  tipBox.innerHTML = '网络连接中...';
